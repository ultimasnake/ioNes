...
(function ($) {
    ...
    */
    ...
    $.touch = {
        ...
        historyMaxSize: 64,
        /** historyFilterPredicates defioNes a number of predicates that can be used in TouchHistory#filter() and TouchHistory#find(). */
        ...
        /** historyMatchPredicates defioNes a number of predicates that can be used in TouchHistory#match(). */
